...
<div class="cart_totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">
	...
	<table cellspacing="0" class="shop_table shop_table_responsive">
		...
		<tr class="cart-subtotal">
			<th class="d-none"><?php esc_html_e('Subtotal', 'woocommerce'); ?></th>
			<td data-title="<?php esc_attr_e('Subtotal', 'woocommerce'); ?>"><?php wc_cart_totals_subtotal_html(); ?></td>
		</tr>

		<?php foreach (WC()->cart->get_coupons() as $code => $coupon) : ?>
			<tr class="cart-discount coupon-<?php echo esc_attr(sanitize_title($code)); ?>">
				<th class="d-none"><?php wc_cart_totals_coupon_label($coupon); ?></th>
		...
		<tr class="order-total">
			<th class="d-none"><?php esc_html_e('Total', 'woocommerce'); ?></th>
	...
	<div class="wc-proceed-to-checkout">
		...
		<a href="<?= get_permalink(woocommerce_get_page_id('shop')); ?>" class="button alt">
			بازگشت به فروشگاه</a>
	</div>
