...
if( have_posts() ) :
	...
	while( have_posts() ) : the_post();
		...
		$timeForRead = round(str_word_count($postContent)*0.12/60);
		$timefr = $timeForRead == '0' ? 'کمتر از یک دقیقه' : $timeForRead . ' دقیقه ';
		?>
        <div class="row container">
            <div class="post_data">
                <span class="post_views_count"><?= gt_get_post_view(); ?></span>
                <span class="post_read_time">زمان تقریبی مطالعه: <?= $timefr; ?></span>
            </div>
        </div>
		...
		?>
        <div class="single_post_share_btns">
            <div class="w-100">
                <ul>
                    <li class="icons ln"><a href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $postUrl; ?>" rel="nofollow" target="_blank"><i class="ic-linkedin"></i></a></li>
