...
function load_scripts_styles() {
  ...
  // Styles
  if (get_locale() === 'en_US'){
	wp_enqueue_style( 'child-theme-styles' , get_stylesheet_directory_uri() . '/css/main.css' , array() , '8.1');
	wp_enqueue_style( 'child-theme-styles-en' , get_stylesheet_directory_uri() . '/css/style-ltr.css');
  } elseif (get_locale() === 'fa_IR'){
	wp_enqueue_style( 'child-theme-styles' , get_stylesheet_directory_uri() . '/css/main.css' , array() , '8.2');
  } else {
	wp_enqueue_style( 'child-theme-styles' , get_stylesheet_directory_uri() . '/css/main.css' , array() , '8.2');
  }
  // Scripts
