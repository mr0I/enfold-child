...
<head>
	...
	<script>
		...
		})(window, document, 'script', 'dataLayer', 'GTM-M7R5RMX');
	</script>
...
<body id="top" <?php body_class($custom_body_classes . ' ' . $rtl_support . $style . " " . $avia_config['font_stack'] . " " . $blank . " " . $sidebar_styling);
	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M7R5RMX" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
