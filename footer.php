                        ...
                        <div class="tr-element">
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
                                    ...
                                    <ul id="addr_column">
                                        <li>
                                            اصفهان خیابان کاشانی، خیابان صاحب روضات، کوچه شماره ۱۲ (پویا)، شرکت رادشید - کدپستی: 8183873541
                                            <p>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
                                    <div class="enamad-container my-2">
                                        <a referrerpolicy="origin" target="_blank" href="https://trustseal.enamad.ir/?id=179501&amp;Code=FhjbxasmXXMZd5Y5vKZc"><img referrerpolicy="origin" src="https://Trustseal.eNamad.ir/logo.aspx?id=179501&amp;Code=FhjbxasmXXMZd5Y5vKZc" alt="" style="cursor:pointer" id="FhjbxasmXXMZd5Y5vKZc"></a>
                                    </div>

                                    <div class="apps-wrapper">
                                        <a target="_blank" class="" href="https://rx4.ir/android">
                                            <img src="https://radshid.com/wp-content/uploads/2022/03/android-icon.png" alt="دانلود اپلیکیشن ردیابی رادشید نسخه اندروید">
                                        </a>
                                        <a target="_blank" class="" href="https://rx4.ir/ios">
                                            <img src="https://radshid.com/wp-content/uploads/2022/03/ios-icon.png" alt="ورود به برنامه ردیابی رادشید نسخه آی او اس">
                                        </a>
        ...
        <div class="notif_banner_container">
            <div class="rightSide">
                <figure class="banner_logo">
                    <img src="<?php echo RAD_ASSETS . '/images/notices_banner/radassistant.png'; ?>" width="80" height="80" alt="banner_logo">
                </figure>
            </div>
            <div class="leftSide">
    ...
    ?>
        <div class="floated_icons_footer">
            <div class="fif-container">
                ...
                <a href="https://radshid.com/product/%d8%b1%d8%af%db%8c%d8%a7%d8%a8-%d8%b4%d8%ae%d8%b5%db%8c-%d8%a8%d8%a7-%d9%82%d8%a7%d8%a8%d9%84%db%8c%d8%aa-%d9%85%da%a9%d8%a7%d9%84%d9%85%d9%87-%d8%af%d9%88-%d8%b7%d8%b1%d9%81%d9%87/">
                    <i class="ic-pin"></i><span>ردیاب کودک و سالمند</span>
                </a>
            </div>
        </div>
    <?php
